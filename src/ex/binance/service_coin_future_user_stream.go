...
func (as *apiService) StartCoinFutureUserDataStream() (*Stream, error) {
...
func (as *apiService) KeepAliveCoinFutureUserDataStream(s *Stream) error {
	params := make(map[string]string)
...
func (as *apiService) CloseCoinFutureUserDataStream(s *Stream) error {
	params := make(map[string]string)
	params["listenKey"] = s.ListenKey
